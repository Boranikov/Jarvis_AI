...
hiddenimports = ['uvicorn.logging', 'uvicorn.loops', 'uvicorn.loops.auto', 'uvicorn.protocols', 'uvicorn.protocols.http', 'uvicorn.protocols.http.auto', 'uvicorn.protocols.websockets', 'uvicorn.protocols.websockets.auto', 'uvicorn.lifespan', 'uvicorn.lifespan.on', 'httptools', 'httptools.parser', 'httptools.parser.parser', 'dotenv', 'pystray._win32', 'ollama', 'httpx', 'qdrant_client', 'mcp', 'structlog', 'tenacity', 'pydantic_settings']
...
a = Analysis(
    ['C:\\Users\\boran\\Desktop\\Jarvis_Aİ\\jarvis_tray.py'],
    pathex=[],
    binaries=[],
